...
class PixelExtractor(nn.Module):
    ...
    def __init__(self, obs_shape, env, feature_dim, num_layers=2, num_filters=32, num_fc=1, *args):
        super().__init__()
...
def make_extr(obs_shape, env, extr_latent_dim, num_layers, num_filters, num_fc, **args):
    return PixelExtractor(obs_shape, env, extr_latent_dim, num_layers, num_filters, num_fc)
